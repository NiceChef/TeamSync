      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-xl">
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-xs text-slate-500">
            Typ konta (pracownik / klient) ustala serwer na podstawie domeny e-mail — zgodnie z konfiguracją
            administratora (<code className="rounded bg-slate-100 px-1">CLIENT_EMAIL_DOMAINS</code>).
          </p>
        </div>
