            ...
            >
                ...
                <td className="px-4 py-3 align-middle" data-label="Temat">
                    ...
                    >
                        ...
                        <div className="ml-2 inline-flex shrink-0 items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400">
                            {Number(task.comment_count || 0) > 0 && (
                                <span
                                    className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5 dark:bg-slate-800"
                                    title={`Komentarze: ${task.comment_count}`}
                                >
                            ...
                            {Number(task.attachment_count || 0) > 0 && (
                                <span
                                    className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-2 py-0.5 dark:bg-slate-800"
                                    title={`Pliki: ${task.attachment_count}`}
                                >
