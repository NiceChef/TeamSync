  ...
  return (
    <AppLayout user={user} onLogout={handleLogout}>
      <Routes>
        ...
        <Route path="/reports" element={<Suspense fallback={<div className="p-8 text-sm text-slate-500 dark:text-slate-400">Ładowanie raportów…</div>}>
          <Reports isAuthenticated /></Suspense>} />
        <Route path="/authorization" element={<Authorization isAuthenticated />} />
